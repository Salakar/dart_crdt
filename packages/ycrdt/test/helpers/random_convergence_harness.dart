...
int randomConvergenceSeed({
  ...
  final value = (environment ?? Platform.environment)['YCRDT_RANDOM_SEED'];
...
bool shouldRunLongRandomConvergenceTests({
  ...
  return (environment ?? Platform.environment)['YCRDT_LONG_RANDOM'] == '1';
}
...
final class RandomConvergenceHarness<T extends Object> {
  ...
  String reproductionCommand() {
    return 'YCRDT_RANDOM_SEED=$seed dart test $testFile '
